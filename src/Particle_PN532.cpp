/**************************************************************************/
/*! 
    @file     Particle_PN532.cpp
    @author   Adafruit Industries, Paul Kourany, Technobly, @dan-os
...
*/
/**************************************************************************/
Particle_PN532::Particle_PN532(uint8_t clk, uint8_t miso, uint8_t mosi, uint8_t ss) {
  _clk = clk;
  _miso = miso;
  _mosi = mosi;
  _ss = ss;
...
*/
/**************************************************************************/
Particle_PN532::Particle_PN532(uint8_t irq, uint8_t reset) {
  _irq = irq;
  _reset = reset;
...
*/
/**************************************************************************/
void Particle_PN532::PrintHex(const byte * data, const uint32_t numBytes)
{
  uint32_t szPos;
...
*/
/**************************************************************************/
void Particle_PN532::PrintHexChar(const byte * data, const uint32_t numBytes)
{
  uint32_t szPos;
  for (szPos=0; szPos < numBytes; szPos++) 
  {
...
*/
/**************************************************************************/
uint32_t Particle_PN532::getFirmwareVersion(void) {
  uint32_t response;
...
boolean Particle_PN532::sendCommandCheckAck(uint8_t *cmd, uint8_t cmdlen, uint16_t timeout) {
  uint16_t timer = 0;
...
*/
/**************************************************************************/
boolean Particle_PN532::writeGPIO(uint8_t pinstate) {
...
*/
/**************************************************************************/
uint8_t Particle_PN532::readGPIO(void) {
...
*/
/**************************************************************************/
boolean Particle_PN532::SAMConfig(void) {
...
*/
/**************************************************************************/
boolean Particle_PN532::setPassiveActivationRetries(uint8_t maxRetries) {
...
*/
/**************************************************************************/
boolean Particle_PN532::readPassiveTargetID(uint8_t cardbaudrate, uint8_t * uid, uint8_t * uidLength) {
...
*/
/**************************************************************************/
bool Particle_PN532::mifareclassic_IsFirstBlock (uint32_t uiBlock)
{
...
*/
/**************************************************************************/
bool Particle_PN532::mifareclassic_IsTrailerBlock (uint32_t uiBlock)
{
  // Test if we are in the small or big sectors
  if (uiBlock < 128)
...
*/
/**************************************************************************/
uint8_t Particle_PN532::mifareclassic_AuthenticateBlock (uint8_t * uid, uint8_t uidLen, uint32_t blockNumber, uint8_t keyNumber, uint8_t * keyData)
{
  uint8_t i;
  ...
  if (pn532_packetbuffer[7] != 0x00)
  {
    ...
    Particle_PN532::PrintHexChar(pn532_packetbuffer, 12);
    #endif
    return 0;
  }
...
*/
/**************************************************************************/
uint8_t Particle_PN532::mifareclassic_ReadDataBlock (uint8_t blockNumber, uint8_t * data)
{
  #ifdef MIFAREDEBUG
  ...
  if (pn532_packetbuffer[7] != 0x00)
  {
    ...
    Particle_PN532::PrintHexChar(pn532_packetbuffer, 26);
    //#endif
    return 0;
  }
  ...
  /* Display data for debug if requested */
    ...
    Particle_PN532::PrintHexChar(data, 16);
  #endif
...
*/
/**************************************************************************/
uint8_t Particle_PN532::mifareclassic_WriteDataBlock (uint8_t blockNumber, uint8_t * data)
{
  #ifdef MIFAREDEBUG
...
*/
/**************************************************************************/
uint8_t Particle_PN532::mifareclassic_FormatNDEF (void)
{
...
*/
/**************************************************************************/
uint8_t Particle_PN532::mifareclassic_WriteNDEFURI (uint8_t sectorNumber, uint8_t uriIdentifier, const char * url)
{
...
*/
/**************************************************************************/
uint8_t Particle_PN532::mifareultralight_ReadPage (uint8_t page, uint8_t * buffer)
{
  if (page >= 64)
  {
    #ifdef MIFAREDEBUG
  ...
  /* Display data for debug if requested */
    ...
    Particle_PN532::PrintHexChar(buffer, 4);
  #endif
...
*/
/**************************************************************************/
boolean Particle_PN532::readack() {
  uint8_t ackbuff[6];
...
*/
/**************************************************************************/
uint8_t Particle_PN532::readstatus(void) {
#if PN532_MODE == PN532_SPI_MODE
  digitalWrite(_ss, LOW);
  delay(2); 
...
*/
/**************************************************************************/
void Particle_PN532::readdata(uint8_t* buff, uint8_t n) {
#ifdef PN532DEBUG
...
*/
/**************************************************************************/
void Particle_PN532::writecommand(uint8_t* cmd, uint8_t cmdlen) {
  uint8_t checksum;
...
*/
/**************************************************************************/
void Particle_PN532::writebyte(uint8_t c) {
#if PN532_MODE == PN532_SPI_MODE
#if (PN532_HW_SPI == 1)
  SPI.transfer(c);
#else
...
*/
/**************************************************************************/
uint8_t Particle_PN532::readbyte(void) {
#if PN532_MODE == PN532_SPI_MODE
#if (PN532_HW_SPI == 1)
...
*/
/**************************************************************************/
boolean Particle_PN532::waitUntilReady(uint16_t timeout) {
  uint16_t timer = 0;
  while(readstatus() != PN532_READY) {
    if (timeout != 0) {
      timer += 10;
...
*/
/**************************************************************************/
boolean Particle_PN532::inDataExchange(uint8_t * send, uint8_t sendLength, uint8_t * response, uint8_t * responseLength) {
...
*/
/**************************************************************************/
boolean Particle_PN532::inListPassiveTarget() {
  pn532_packetbuffer[0] = PN532_COMMAND_INLISTPASSIVETARGET;
